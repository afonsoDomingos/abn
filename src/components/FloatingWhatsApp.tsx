  ...
  const socials = [
    {
      ...
      bg: '#25d366',
      tooltip: language === 'pt' ? 'WhatsApp' : 'WhatsApp',
      icon: (
    ...
    },
    {
      ...
      tooltip: language === 'pt' ? 'Instagram' : 'Instagram',
      icon: (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      bg: '#1877f2',
      tooltip: language === 'pt' ? 'Facebook' : 'Facebook',
      icon: (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      bg: '#0a66c2',
      tooltip: language === 'pt' ? 'LinkedIn' : 'LinkedIn',
      icon: (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      bg: '#ff0000',
      tooltip: language === 'pt' ? 'YouTube' : 'YouTube',
      icon: (
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className={styles.dockWrapper}>
      ...
      >
        <span className={styles.triggerIcon}>
          {isOpen ? <X size={11} strokeWidth={2.5} /> : <Share2 size={11} strokeWidth={2.5} />}
        </span>
